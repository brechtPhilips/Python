...
def get_locations(cells):
    """Randomly pick starting locations for the monster, the door and player:
...
def get_moves(player):
    """Based on the tuple of the players position, return the list
    of acceptable moves
...
def move_player(player, move):
    """Moving the player to a new location

    >>> player = {'location': (0,2), 'path': []}
